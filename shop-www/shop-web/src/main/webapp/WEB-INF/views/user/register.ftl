    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            $("#captchaImage").click(function() {
                $(this).hide().attr("src", "${ctx}/kaptcha/getKaptchaImage?timestamp=" + new Date().getTime())
                        .fadeIn();
            });
            ...
            $("#submitBtn").click(function() {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        $("#submitBtn").prop("disabled", true); // 目的防止重复提交 token机制
                    },
                    success: function(data) {
                        if(data.resultCode == 0) {// 失败打印消息
                            ...
                            if (redirectUrl == null || redirectUrl.trim().length < 1) {
                                redirectUrl = "index";
                            }
            ...
            $("#sendVerifyCodeBtn").click(function() {
                ...
                $.get("${ctx}/sms/send", {phone:phone}, function(data){
                    ...
                    <form id="registerForm" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="button" id="submitBtn" class="submit" value="同意以下协议并注册" />
                                </td>
                            </tr>
                            <tr>
                                <th>
